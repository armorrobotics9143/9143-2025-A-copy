...
public class Swerve extends TunerSwerveDrivetrain implements Subsystem {
    ...
    private final NetworkTable trackingTable = NetworkTableInstance.getDefault().getTable("AprilTagTracking");
    private final DoubleSubscriber targetDistanceSub = trackingTable.getDoubleTopic("targetDistance").subscribe(0);
    private final DoubleSubscriber currentDistanceSub = trackingTable.getDoubleTopic("currentDistance").subscribe(0);
    private final DoubleSubscriber angleToTargetSub = trackingTable.getDoubleTopic("angleToTarget").subscribe(0);
